...
namespace AspNetCore.Proxy
{
    ...
    public static class Basic
    {
        ...
        public static IServiceCollection AddProxies(
            ...
            Action<HttpClient> configureProxyClient = null
        )
        {
            services.AddRouting();
        ...
        public static IApplicationBuilder UseProxies(
            this IApplicationBuilder app,
            Action<IProxiesBuilder> builderAction
        )
        {
            ...
            app.UseRouter(builder =>
            {
                ...
                {
                    builder.MapMiddlewareRoute(
                        proxy.Route,
                        proxyApp =>
                            proxyApp.Run(context => context.ExecuteProxyOperationAsync(proxy))
                    );
                }
            });
        ...
        public static void RunProxy(
            this IApplicationBuilder app,
            Action<IProxyBuilder> builderAction
        )
        {
            ...
            if (
                proxy.HttpProxy?.EndpointComputer.Clone()
                is EndpointComputerToValueTask oldHttpEndpointComputer
            )
                proxy.HttpProxy.EndpointComputer = GetRunProxyComputer(oldHttpEndpointComputer);
            if (
                proxy.WsProxy?.EndpointComputer.Clone()
                is EndpointComputerToValueTask oldWsEndpointComputer
            )
        ...
        public static void RunHttpProxy(
            this IApplicationBuilder app,
            Action<IHttpProxyBuilder> httpBuilderAction
        ) => app.RunProxy(builder => builder.UseHttp(httpBuilderAction));
        ...
        public static void RunHttpProxy(
            ...
            app.RunHttpProxy(
                builder =>
                    builder.WithEndpoint(httpEndpointComputer).WithOptions(httpBuilderOptionsAction)
            );
        ...
        public static void RunHttpProxy(
            ...
            app.RunHttpProxy(
                builder => builder.WithEndpoint(httpEndpoint).WithOptions(httpBuilderOptionsAction)
            );
        ...
        public static void RunWsProxy(
            this IApplicationBuilder app,
            Action<IWsProxyBuilder> wsBuilderAction
        ) => app.RunProxy(builder => builder.UseWs(wsBuilderAction));
        ...
        public static void RunWsProxy(
            ...
            app.RunWsProxy(
                builder =>
                    builder.WithEndpoint(wsEndpointComputer).WithOptions(wsBuilderOptionsAction)
            );
        ...
        public static void RunWsProxy(
            ...
            app.RunWsProxy(
                builder => builder.WithEndpoint(wsEndpoint).WithOptions(wsBuilderOptionsAction)
            );
        ...
        public static Task ProxyAsync(
            ...
            WsProxyOptions wsProxyOptions = null
        )
        {
            var httpProxy = new HttpProxy(
                (c, a) => new ValueTask<string>(httpEndpoint),
                httpProxyOptions
            );
        ...
        )
        {
            return controller
                .HttpContext
                .ProxyAsync(httpEndpoint, wsEndpoint, httpProxyOptions, wsProxyOptions);
        }
        ...
        /// <param name="httpProxyOptions">The HTTP options.</param>
        /// <returns>A <see cref="Task"/> which completes when the request has been successfully proxied and written to the response.</returns>
        public static Task HttpProxyAsync(
            this HttpContext context,
            string httpEndpoint,
            HttpProxyOptions httpProxyOptions = null
        )
        {
            var httpProxy = new HttpProxy(
                (_, _) => new ValueTask<string>(httpEndpoint),
                httpProxyOptions
            );
        ...
        /// <param name="wsProxyOptions">The WS options.</param>
        /// <returns>A <see cref="Task"/> which completes when the request has been successfully proxied and written to the response.</returns>
        public static Task WsProxyAsync(
            this HttpContext context,
            string wsEndpoint,
            WsProxyOptions wsProxyOptions = null
        )
        ...
        internal static async Task ExecuteProxyOperationAsync(
            this HttpContext context,
            Builders.Proxy proxy
        )
        {
            ...
            await context
                .Response
                .WriteAsync(
                    $"Request could not be proxied.\n\nThe {requestType} request cannot be proxied because the underlying proxy definition does not have a definition of that type."
                )
                .ConfigureAwait(false);
        }

        internal static ValueTask<string> GetEndpointFromComputerAsync(
            this HttpContext context,
            EndpointComputerToValueTask computer
        ) => computer(context, context.GetRouteData()?.Values);

        internal static EndpointComputerToValueTask GetRunProxyComputer(
            EndpointComputerToValueTask endpointComputer
        )
        {
